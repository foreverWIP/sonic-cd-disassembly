...
; -------------------------------------------------------------------------
	...
	if ROMHACK=0
	if REGION=USA
	binclude	"Level/Palmtree Panic/Data/Padding/1 (Act 1 Bad Future, U).bin"
	else
	binclude	"Level/Palmtree Panic/Data/Padding/1 (Act 1 Bad Future, JE).bin"
	endif
	else
	align $10000
	endif
...
LevelChunks:
	binclude	"Level/Palmtree Panic/Data/Chunks (Act 1 Bad Future).bin"
	even
Ani_Powerup:
...
; -------------------------------------------------------------------------
	...
	if ROMHACK=0
	if REGION=USA
	binclude	"Level/Palmtree Panic/Data/Padding/2 (Act 1 Bad Future, U).bin"
	else
	binclude	"Level/Palmtree Panic/Data/Padding/2 (Act 1 Bad Future, JE).bin"
	endif
	else
	align $20000
	endif
...
ColWidthMap:
	...
	even
LevelCollision:
	binclude	"Level/Palmtree Panic/Data/Collision (Act 1 Bad Future).bin"
	even
...
.FG:
	binclude	"Level/Palmtree Panic/Data/Foreground (Act 1 Bad Future).bin"
	even
.BG:
	binclude	"Level/Palmtree Panic/Data/Background (Act 1 Bad Future).bin"
	even
.Null:
	dc.b	0, 0, 0, 0
.FG2:
...
Art_Scenery:
	...
	even
LevelBlocks:
	binclude	"Level/Palmtree Panic/Data/Blocks (Act 1 Bad Future).nem"
	even
Art_LevelTiles:
	binclude	"Level/Palmtree Panic/Data/Tiles (Act 1 Bad Future).nem"
	even
Art_Projector:
...
; -------------------------------------------------------------------------
	...
	if ROMHACK=0
	binclude	"Level/Palmtree Panic/Data/Padding/3 (Act 1 Bad Future).bin"
	else
	align $40000
	endif
